...
export class Type  implements IType{
    ...
    public addProperty(propertyName: string, propertyType: TypeNameInfo, required: boolean, enumValue?: Array<string | boolean | number | {}>, additionalTypeNameInfo?: TypeNameInfo) {
        if (this.isGeneric){
